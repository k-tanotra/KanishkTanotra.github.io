...
const Name = () => {
  return (
    ...
    <h1 className="text-base sm:text-sm md:text-lg text-transparent bg-clip-text bg-gradient-to-r from-slate-50 to-slate-200">
      Im a Software Engineer who thrives on solving complex problems and bringing ideas to life. Whether its crafting efficient, user-friendly applications or optimizing systems, I love building solutions from the ground up and continuously learning along the way.
    </h1>
    <div className="p-5"></div>
  </section>
  )
